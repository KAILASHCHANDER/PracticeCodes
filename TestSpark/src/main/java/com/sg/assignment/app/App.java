...
import static com.sg.assignment.app.SerializableComparator.serialize;
...
public class App 
{
	...
	//	SparkConf conf = new SparkConf().setAppName("firstSparkProject").setMaster("local[*]");
		SparkSession spark = new Builder().appName("firstSparkProject").master("local[*]").getOrCreate();
